...
public class S_reciept extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_s_reciept);
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                switch (selectedClass)
                {
                    case "Class 1":
                        ...
                        divSpinner.setAdapter(new ArrayAdapter<String>(S_reciept.this,
