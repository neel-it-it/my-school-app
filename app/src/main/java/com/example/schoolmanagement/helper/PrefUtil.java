...
public class PrefUtil {
    ...
    public static void putstringPref(String key, String value, Context context) {
        SharedPreferences preferences = context.getSharedPreferences("BirthdayOffers", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = preferences.edit();
    ...
    public static String getstringPref(String key, Context context) {
        SharedPreferences references = context.getSharedPreferences("BirthdayOffers", Context.MODE_PRIVATE);
